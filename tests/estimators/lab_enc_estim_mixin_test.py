...
from estim_with_lab_encoder.estimators.lab_enc_estim_mixin import ClassifierWithLabelEncoderMixin
from sklearn.neighbors import KNeighborsClassifier
from sklearn.linear_model import LogisticRegression
from sklearn.neural_network import MLPClassifier
from sklearn.utils.estimator_checks import check_estimator

class KNNBatchClassifier(ClassifierWithLabelEncoderMixin, KNeighborsClassifier):
    pass

class LogisticBatchClassifier(ClassifierWithLabelEncoderMixin, LogisticRegression):
    pass

class MLPBatchClassifier(ClassifierWithLabelEncoderMixin, MLPClassifier):
    pass

class ClassifierWithLabelEncoderMixinTest(unittest.TestCase):
